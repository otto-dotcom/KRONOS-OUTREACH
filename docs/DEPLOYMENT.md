...
├── config/                     # Industry-specific scraping + scoring config
├── directives/                 # Strategy docs (AI context for workflows)
├── docs/                       # Comprehensive documentation & deployment guides
├── infra/                      # Infrastructure (Docker, Caddy, VPS setup)
├── scripts/                    # Utility scripts & n8n API manager
...
- [ ] Run setup: `sudo ./infra/setup_vps.sh`
...
- [ ] Import workflows from `workflows/` via n8n UI (Import from File)
